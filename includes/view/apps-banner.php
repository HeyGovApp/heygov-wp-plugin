...
<div class="heygov-apps-banner" style="background-color: <?php echo $heygov_banner_bg_color ?>">
	<div class="heygov-apps-banner-image">
		...
		<img src="<?php echo $heygov_banner_img_small ?>" class="heygov-apps-banner-image-small" alt="HeyGov" />
	</div>

	<div class="heygov-apps-banner-links">
		<a href="https://apps.apple.com/app/id1560855064" class="heygov-link-ios" target="_blank"><img src="<?php echo HEYGOV_URL ?>assets/badge-app-store.svg" alt="Apple App Store" /></a>
		<a href="https://play.google.com/store/apps/details?id=com.heygov.app" class="heygov-link-android" target="_blank"><img src="<?php echo HEYGOV_URL ?>assets/badge-play-store.png" alt="Google Play Store" /></a>
	</div>
</div>
